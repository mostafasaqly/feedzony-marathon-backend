...
let AnalyticsController = class AnalyticsController {
    ...
    getOverview(req, period) {
        return this.analyticsService.getOverview(req.user.id, parsePeriod(period));
    }
    getServiceAnalytics(req, serviceId, period) {
        return this.analyticsService.getServiceAnalytics(serviceId, req.user.id, parsePeriod(period));
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AnalyticsController.prototype, "getServiceAnalytics", null);
